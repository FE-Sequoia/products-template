            ...
            <div class="my_header">
                ...
                <div ref="my" v-else class="user">
                  <div ref="own" class="own" @click="my()">
                    <div class="user_pr">
                      ...
                      <div class="own_text">{{ user_nickname }} <span class="caret"
                          v-bind:style="{transform: 'rotate('+ angle2 +'deg)'}" /> </div>
                    </div>
              ...
              <div ref="nav_target" class="nav_list">
                <ul class="nav_ul">
                  ...
                  <li class="nav_li" v-if="$check_action('/subject_exam/table','answers')">
                  ...
                  <li v-if="nav_top.length > top_max" class="nav_li">
                    <div ref="more" class="more" @click="change()">
                      ...
                      <span class="caret" v-bind:style="{transform: 'rotate('+ angle1 +'deg)'}"></span>
                    </div>
              ...
              <div ref="mini" class="mini_nav" @click="open_mini()">
                <div ref="mini" class="mini">
                  ...
                  <span class="caret" v-bind:style="{transform: 'rotate('+ angle3 +'deg)'}"></span>
                </div>
              </div>
            </div>
          </div>
