			...
			<table class="diy_table">
				<tr class="diy_row">
					...
					商品名称
										...
										<th class="diy_title" v-if="$check_field('get','cover','/customized_products/list')">
					封面
				</th>
												<th class="diy_title" v-if="$check_field('get','product_category','/customized_products/list')">
					商品类别
				</th>
														</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
						...
						<span>
							{{ o["product_name"] }}
											...
											<td class="diy_field" v-if="$check_field('get','cover','/customized_products/list')">
						<img class="diy_img" :src="$fullUrl(o['cover'])" />
					</td>
													<td class="diy_field diy_text" v-if="$check_field('get','product_category','/customized_products/list')">
						<span>
							{{ o["product_category"] }}
						</span>
					</td>
