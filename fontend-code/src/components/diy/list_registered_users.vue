		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                ...
                <div  v-for="(o, i) in  list" :key="i" class="slide" >
                    ...
                    <router-link :to="'/registered_users/details?registered_users_id=' + o['registered_users_id']" class="lis_cont">
                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/registered_users/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/registered_users/details?registered_users_id="+v.registered_users_id)
			},
