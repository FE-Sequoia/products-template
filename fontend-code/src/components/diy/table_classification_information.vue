    ...
    <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                               ...
                               v-if="user_group == '管理员' || $check_field('get','classification_categories')" min-width="200">
                                              ...
                                              <el-table-column prop="classification_remarks" @sort-change="$sortChange" label="分类备注"
                               v-if="user_group == '管理员' || $check_field('get','classification_remarks')" min-width="200">
                                </el-table-column>
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                ...
                                <el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="openPayModal(scope.row)" v-if="scope.row.pay_state==='未支付' && (user_group == '管理员' || $check_pay('/classification_information/table'))">
              <span>支付</span>
            </el-button>
                                              </template>
    </el-table-column>
