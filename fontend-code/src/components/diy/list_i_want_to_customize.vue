	...
	<div class="diy_home diy_list diy_i_want_to_customize" id="diy_i_want_to_customize_list">
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
									<th class="diy_title" v-if="$check_field('get','product_name','/i_want_to_customize/list')">
					商品名称
				</th>
										<th class="diy_title" v-if="$check_field('get','cover','/i_want_to_customize/list')">
					封面
				</th>
															</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
										<td class="diy_field diy_text" v-if="$check_field('get','product_name','/i_want_to_customize/list')">
						<span>
							{{ o["product_name"] }}
						</span>
					</td>
											<td class="diy_field" v-if="$check_field('get','cover','/i_want_to_customize/list')">
			...
			get_user_name(name,id){
				var obj = null;
					...
					obj = this.list_user_seller.getObj({"user_id":id});
						...
						if (name == 'purchasing_users'){
					obj = this.list_user_purchasing_users.getObj({"user_id":id});
				}
										var ret = "";
				if(obj){
