  ...
  <el-main class="bg table_wrap">
              ...
              <el-form-item label="分类">
                <el-select v-model="query.cart_type">
                  ...
                  <el-option v-for="(o,i) in list_goods_cart_type" :key="i" :value="o.name" :label="o.name"></el-option>
                                                              ...
                                                              <el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
                      <el-form-item label="商城卖家">
                                                      <el-select v-model="query.mall_seller">
                              <el-option v-for="o in list_mall_seller" :key="o['username']" :label="o['nickname'] + '-' + o['username']"
                                         :value="o['user_id']">
                              </el-option>
                            </el-select>
                                                </el-form-item>
                      ...
                      <el-form-item label="生产日期">
                                                      <el-input v-model="query.production_date"></el-input>
                                                </el-form-item>
                    </el-col>
                                                                                                      <el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
    ...
    <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
          ...
          <el-table-column prop="cart_description" label="描述" min-width="200">
                                          ...
                                          <el-table-column prop="mall_seller" @sort-change="$sortChange" label="商城卖家"
                               v-if="user_group == '管理员' || $check_field('get','mall_seller')" min-width="200">
                                      <template slot-scope="scope">
                      {{ get_user_mall_seller(scope.row['mall_seller']) }}
                    </template>
                                </el-table-column>
                               ...
                               v-if="user_group == '管理员' || $check_field('get','merchant_name')" min-width="200">
                                              ...
                                              <el-table-column prop="production_date" @sort-change="$sortChange" label="生产日期"
                               v-if="user_group == '管理员' || $check_field('get','production_date')" min-width="200">
                                      <template slot-scope="scope">
                      {{ $toTime(scope.row["production_date"],"yyyy-MM-dd") }}
                    </template>
                                </el-table-column>
                                              <el-table-column prop="shelf_life" @sort-change="$sortChange" label="保质期"
                               v-if="user_group == '管理员' || $check_field('get','shelf_life')" min-width="200">
                                      <template slot-scope="scope">
                      {{ $toTime(scope.row["shelf_life"],"yyyy-MM-dd hh:mm:ss") }}
                    </template>
                                </el-table-column>
        ...
        this.showModal = false;
          ...
          async get_goods_cart_type() {
            ...
            if(user_group != "管理员"){
                                  let sqlwhere = "(";
                                                                      if(user_group=="商城卖家"){
                            sqlwhere+= "mall_seller = " + this.$store.state.user.user_id + " or ";
                          }
