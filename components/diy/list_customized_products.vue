	...
	<view class="list_customized_products list_com--new" style="background-color: #fff;">
		...
		<view class="customized_products_block box_wrap" >
			<navigator class="item_customized_products box_style" v-for="(o, i) in list"  :key="i" :url="'/pages/customized_products/details?customized_products_id=' + o['customized_products_id']">
					<view class="view" v-if="0 && $check_index_field('get','product_number','/customized_products/list')">
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="1 && $check_index_field('get','cover','/customized_products/list')">
					<view class="title" v-if=" false">
						...
						<view class="view" v-if="0 && $check_index_field('get','money','/customized_products/list')">
					<view class="title" v-if="true">
						<span>金额</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','inventory','/customized_products/list')">
					<view class="title" v-if="true">
						<span>库存</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','product_category','/customized_products/list')">
					<view class="title" v-if="true">
						<span>商品类别</span>
					</view>
							<view class="diy_field text" >
						<span>{{ o["product_category"] }}</span>
										...
										<view class="view" v-if="0 && $check_index_field('get','content','/customized_products/list')">
					<view class="title" v-if="true">
						<span>内容</span>
					</view>
							<view class="diy_field text" >
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','classification_number','/customized_products/list')">
					<view class="title" v-if="true">
						<span>分类编号</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','classification_categories','/customized_products/list')">
					<view class="title" v-if="true">
						<span>分类类别</span>
					</view>
							<view class="diy_field text" >
