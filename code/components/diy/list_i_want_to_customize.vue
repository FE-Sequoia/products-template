	...
	<view class="list_i_want_to_customize list_com--new" style="background-color: #fff;">
		...
		<view class="i_want_to_customize_block box_wrap" >
			<navigator class="item_i_want_to_customize box_style" v-for="(o, i) in list"  :key="i" :url="'/pages/i_want_to_customize/details?i_want_to_customize_id=' + o['i_want_to_customize_id']">
					<view class="view" v-if="0 && $check_index_field('get','order_number','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','product_number','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>商品编号</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','product_name','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>商品名称</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','cover','/i_want_to_customize/list')">
					<view class="title" v-if=" false">
						...
						<view class="view" v-if="0 && $check_index_field('get','money','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>金额</span>
					</view>
							<view class="diy_field text" >
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','purchasing_users','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>购买用户</span>
					</view>
							<view class="diy_field time" >
						...
						<view class="view" v-if="0 && $check_index_field('get','purchase_quantity','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>购买数量</span>
					</view>
							<view class="diy_field text" >
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','customized_time','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>定制时间</span>
					</view>
							<view class="diy_field time" >
						<span>{{ $toTime(o["customized_time"] ,"yyyy-MM-dd hh:mm:ss") }}</span>
					</view>
						</view>
								<view class="view" v-if="0 && $check_index_field('get','remarks','/i_want_to_customize/list')">
					<view class="title" v-if="true">
						<span>备注</span>
					</view>
							<view class="diy_field text" >
