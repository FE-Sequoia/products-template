	...
	<el-main class="bg edit_wrap">
		...
		<el-row class="row_ce">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="状态" prop="state">
					<el-select :disabled="user_group!=='管理员'" v-model="form.state" placeholder="请选择">
						...
						<el-col v-if="user_group === '管理员' || $check_field('get','seller_id') || $check_field('add','seller_id') || $check_field('set','seller_id')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="卖家编号" prop="seller_id">
												<el-input id="seller_id" v-model="form_sub['seller_id']" placeholder="请输入卖家编号"
							  v-if="user_group === '管理员' || (form_sub['mall_seller_id'] && $check_field('set','seller_id')) || (!form_sub['mall_seller_id'] && $check_field('add','seller_id'))"></el-input>
					<div v-else-if="$check_field('get','seller_id')">{{form_sub['seller_id']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="卖家姓名" prop="seller_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['mall_seller_id'] && $check_field('set','seller_name')) || (!form_sub['mall_seller_id'] && $check_field('add','seller_name'))"></el-input>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/mall_seller/view','set') || $check_action('/mall_seller/view','add') || $check_option('/mall_seller/table','examine')">
