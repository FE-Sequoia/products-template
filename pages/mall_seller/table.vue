<template>
  <view class="page_mall_seller diy_table diy_table_tml" id="mall_seller_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="卖家编号" name="seller_id">
                      <uni-easyinput type="text" v-model="query.seller_id" placeholder="卖家编号" />
                    </uni-forms-item>
                  </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/mall_seller/view?" v-if="user_group == '管理员' || $check_action('/mall_seller/table','add') || $check_action('/mall_seller/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','seller_id')" class="col">
						<view class="view">
                            ...
                            <span>卖家编号</span>
								...
								<text>
									{{ o["seller_id"] }}
													...
													<view v-if="0 && $check_field('get','seller_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>卖家姓名</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-if="user_group == '管理员' || $check_action('/mall_seller/table','del') || $check_action('/mall_seller/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/mall_seller/view?' + field + '=' + o[field]"
                               v-if="user_group == '管理员' || $check_action('/mall_seller/table','set') || $check_action('/mall_seller/view','set') || $check_action('/mall_seller/view','get')" class="btn btn-primary">详情</navigator>
	            					</view>
				</view>
			</view>
		</view>
