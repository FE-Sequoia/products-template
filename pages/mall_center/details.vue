	...
	<view class="page_mall_center diy_detail diy_detail--new" id="mall_center_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					<view v-if="$check_field('get','mall_seller')" class="col-12 col-6">
						<view class="view">
					...
					<view v-if="$check_field('get','production_date')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>生产日期</span>
							</view>
					...
					<view v-if="$check_field('get','shelf_life')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>保质期</span>
							</view>
					...
					<view v-if="$check_field('get','label')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>标签</span>
							</view>
