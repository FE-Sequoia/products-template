<template>
  <view class="page_notification_announcement diy_table diy_table_tml" id="notification_announcement_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="公告标题" name="announcement_title">
                      <uni-easyinput type="text" v-model="query.announcement_title" placeholder="公告标题" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/notification_announcement/view?" v-if="user_group == '管理员' || $check_action('/notification_announcement/table','add') || $check_action('/notification_announcement/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','announcement_title')" class="col">
						<view class="view">
                            ...
                            <span>发布时间</span>
								...
								<text>
									{{ $toTime(o["release_time"],"yyyy-MM-dd hh:mm:ss") }}
													...
													<view v-if="1 && $check_field('get','announcement_type')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>公告类型</span>
                          </view>
								...
								<text>
									{{ o["announcement_type"] }}
													...
													<view v-if="0 && $check_field('get','announcement_content')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>公告内容</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-if="user_group == '管理员' || $check_action('/notification_announcement/table','del') || $check_action('/notification_announcement/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/notification_announcement/view?' + field + '=' + o[field]"
                               v-if="user_group == '管理员' || $check_action('/notification_announcement/table','set') || $check_action('/notification_announcement/view','set') || $check_action('/notification_announcement/view','get')" class="btn btn-primary">详情</navigator>
	            					</view>
				</view>
			</view>
		</view>
