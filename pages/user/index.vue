                          ...
                          <navigator class="my_module" url="/pages/registered_users/table" hover-class="hover">
                            <div>
                              <text>注册用户</text>
                                                                                      ...
                                                                                      <view v-if="$check_action('/mall_seller/table','get')">
                          <navigator class="my_module" url="/pages/mall_seller/table" hover-class="hover">
                            <div>
                              <text>商城卖家</text>
                            </div>
                          </navigator>
                          ...
                          <navigator class="my_module" url="/pages/i_want_to_customize/table" hover-class="hover">
                            <div>
                              <text>我要定制</text>
                                                                                      ...
                                                                                      <view v-if="$check_action('/notification_announcement/table','get')">
                          <navigator class="my_module" url="/pages/notification_announcement/table" hover-class="hover">
                            <div>
                              <text>通知公告</text>
                            </div>
                          </navigator>
