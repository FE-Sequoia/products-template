						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="avatar" name="avatar" label="头像">
									<view class="diy_field diy_img" v-if="form.avatar">
										<image :src="$fullUrl(form.avatar)" @click="change_img('avatar')" />
									</view>
									<view class="diy_field diy_img" v-else-if="!form.avatar">
								...
								<form_registered_users v-if="form.user_group === '注册用户'" @change="handleSubFormChange" :form="form_sub" ></form_registered_users>
										<!-- 商城卖家 -->
								<form_mall_seller v-if="form.user_group === '商城卖家'" @change="handleSubFormChange" :form="form_sub" ></form_mall_seller>
...
<script>
	...
	import form_registered_users from "@/components/diy/form_registered_users";
			/* 商城卖家 */
	import form_mall_seller from "@/components/diy/form_mall_seller";
