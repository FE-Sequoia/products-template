                            ...
                            <span>订单号</span>
								...
								<text>
									{{ o["order_number"] }}
													...
													<view v-if="0 && $check_field('get','product_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商品编号</span>
                          </view>
                          ...
                          <view class="diy_title" v-if=" false">
                            <span>封面</span>
								...
								<img :src="$fullUrl(o['cover'])" />
													...
													<view v-if="0 && $check_field('get','money')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>金额</span>
                          </view>
                            ...
                            <span>购买数量</span>
								...
								<text>
									{{ o['purchase_quantity'] }}
													...
													<view v-if="0 && $check_field('get','total_amount')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>总金额</span>
                          </view>
								...
								<text>
									{{ o["total_amount"] }}
													...
													<view v-if="0 && $check_field('get','customized_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>定制时间</span>
                          </view>
								...
								<text>
									{{ $toTime(o["customized_time"],"yyyy-MM-dd hh:mm:ss") }}
								</text>
							</view>
										</view>
					</view>
