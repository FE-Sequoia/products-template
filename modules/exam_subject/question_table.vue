...
export default {
  ...
  methods: {
    ...
    get_view_url(row){
      let url = '/exam_subject/question_view?' + this.field + '=' + row[this.field];
      if (this.query && this.query.exam_id){
        url = url + '&exam_id='+this.query.exam_id
      }
      return url
    }
  },
