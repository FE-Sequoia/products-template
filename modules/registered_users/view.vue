				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_registered_users v-if="$check_action('/registered_users/view','get')"></view_registered_users>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_registered_users from "../../components/diy/view_registered_users.vue";
	export default {
		data() {
			return {
			};
