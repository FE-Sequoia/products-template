<template>
	<div class="page_root" id="root_demo">
		...
		<!-- 推荐定制商品模块(结束) -->
							<!-- 推荐通知公告模块(开始) -->
		<div class="ins warp model2" v-if="$check_action('/notification_announcement/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/notification_announcement/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 通知公告推荐列表组件 -->
						<div class="list_notification_announcement_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_notification_announcement :list="list_notification_announcement" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		methods: {
		   ...
		   this.chatList.length && (reallyTime =	nowTimeChuo - this.chatList[this.chatList.length-1]['nowTime'] > spaceTime ?  nowTime : "");
			...
			get_customized_products() {
				...
				url = url_get_list;
										url = "~/api/customized_products/get_hits_list?";
								let param = {
