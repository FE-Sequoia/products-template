<template>
	<div class="diy_details page_notification_announcement" id="notification_announcement_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_notification_announcement'>
							<div_notification_announcement :obj="obj"></div_notification_announcement>
...
<script>
	import div_notification_announcement from "@/components/diy/div_notification_announcement.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.notification_announcement_id;
				}
			},
			/**
			 * 获取点赞
