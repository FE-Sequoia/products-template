				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 商城卖家 -->
							<div><span>商城卖家</span></div>
							<view_mall_seller v-if="$check_action('/mall_seller/view','get')"></view_mall_seller>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_mall_seller from "../../components/diy/view_mall_seller.vue";
	export default {
		data() {
			return {
			};
